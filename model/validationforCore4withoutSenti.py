...
compare_wide.to_csv("core4_compare_wide_withoutSenti.csv", index=False, float_format="%.2f", encoding="utf-8-sig")
...
future_wide.to_csv("core4_future_daily_wide_withoutSenti.csv", index=False, float_format="%.2f", encoding="utf-8-sig")
print("Saved: core4_future_daily_wide_withoutSenti.csv")
